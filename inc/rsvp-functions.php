...
function configurar_smtp($phpmailer) {
    ...
    $phpmailer->FromName = 'Fabiola and Nellit´s Wedding';
}
...
function sendAdminEmail($guest_name, $guests, $allergies, $email) {
    ...
    <body>
        <div class="header">
            ...
            <p>Fabiola and Nellit´s Wedding</p>
        </div>
    ...
    $message .= '
        ...
        <div class="footer">
            ...
            <p>Fabiola and Nellit´s Wedding - January 16th, 2026 - Cartagena, Colombia</p>
        </div>
    </body>
    </html>';
...
function sendGuestEmail($guest_name, $email) {
    $subject = '💌 RSVP Confirmation - Fabiola and Nellit´s Wedding';
