...
export const initCountdown = (targetDate, containerId) => {
    ...
    container.innerHTML = `
        <div class="countdown">
            <div class="d-flex flex-column text-center text-secondary fs-xl-1-lg fs-1">
                <span class="" id="${containerId}-days">00</span>
                <label class="fs-xl-3 fs-6 text-uppercase">days</label>
            </div>
            <div class="d-flex flex-column text-center text-secondary fs-xl-1-lg fs-1">
                <span class="" id="${containerId}-hours">00</span>
                <label class="fs-xl-3 fs-6 text-uppercase">hours</label>
            </div>
            <div class="d-flex flex-column text-center text-secondary fs-xl-1-lg fs-1">
                <span class="" id="${containerId}-minutes">00</span>
                <label class="fs-xl-3 fs-6 text-uppercase">minutes</label>
            </div>
            <div class="d-flex flex-column text-center text-secondary fs-xl-1-lg fs-1">
                <span class="" id="${containerId}-seconds">00</span>
                <label class="fs-xl-3 fs-6 text-uppercase">seconds</label>
            </div>
        </div>
    `;
