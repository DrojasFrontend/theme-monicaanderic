  ...
  "bars_pubs" => [
    ...
    "places" => [
        ...
        [
            ...
            "image" => THEME_IMG . 'places-cartagena/bares-03.jpg',
        ],
        [
            "name" => "La Jugada",
            "address" => "Cra. 6 # 34 - 25",
                        ...
                        <div class="position-relative customSectionBox text-center py-5 shadow-1 rounded-5">
                            <div class="col-12 col-xl-9 mx-auto text-start px-xl-0 px-3">
                                ...
                                <div class="mb-xl-5">
                                    ...
                                    <p class="fs-xl-3 text-secondary mb-4">December in Cartagena offers warm and sunny days, with temperatures around 31 °C (88 °F) and pleasant evenings of about 26 °C (79 °F). Rainfall is minimal during this season, and the sea remains a delightful 27–28 °C (81–82 °F), perfect for enjoying both the city and the beach.</p>
