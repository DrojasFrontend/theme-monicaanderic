                                    ...
                                    <?php foreach ($placesCartagena as $place) { ?>
                                        <div class="swiper-slide">
                                            <div class="bg-white p-3 pb-4">
                                                ...
                                                <p class="fs-xl-3 fs-4 text-secondary mt-3 text-uppercase"><?php echo $place["name"]; ?></p>
                                                <span class="line line--small m-0 my-3"></span>
                                                <p class="fs-xl-6 text-secondary"><?php echo $place["copy"]; ?></p>
                                            </div>
                                        </div>
                                    <?php } ?>
                                <?php } ?>
