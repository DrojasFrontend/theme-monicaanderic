...
<div class="d-inline-block pt-1 ps-lg-4">
    <div class="w-auto d-flex align-items-center gap-lg-2 gap-1 text-white fs-p-lg">
        <?php foreach ($idiomas as $codigo => $datos): ?>
            <?php if ($codigo === $TRP_LANGUAGE): ?>
                <span class="language language-active">
                    <img src="<?php echo $datos['bandera']; ?>" alt="<?php echo $datos['nombre']; ?>" class="flag-icon me-1" width="30" height="20">
                    <!-- <?php echo $datos['nombre']; ?> -->
                </span>
            <?php else: ?>
                
                <a class="language" href="<?php echo $url_converter->get_url_for_language($codigo); ?>" class="language-inactive">
                    <img src="<?php echo $datos['bandera']; ?>" alt="<?php echo $datos['nombre']; ?>" class="flag-icon me-1" width="30" height="20">
                    <!-- <?php echo $datos['nombre']; ?> -->
                </a>
            <?php endif; ?>
